...
<template>
	<div class="max-w-7xl mx-auto sm:p-10">
		<div class="max-w-3xl mx-auto w-full">
			<div class="sm:my-32 my-10">
				<div>
					<div class="grid justify-center gap-4">
						<img :src="image" class="h-40 rounded-full mx-auto" alt="" />
						<h1
							class="text-center text-3xl sm:text-4xl sm:tracking-widest uppercase font-extrabold text-teal-300"
						>
							Norjamille Kasan
						</h1>
						...
						<div class="flex justify-center space-x-6 pt-5">
							<a href="#" class="group">
								<svg
									...
									viewBox="0 0 24 24"
									class="h-8 rounded-sm fill-white"
								>
					...
					>
						<div class="grid gap-3">
							...
							<p class="text-white ind">
								...
								building beautiful and user-friendly web applications. I have
								experience building application with Laravel , VueJS, InertiaJS,
								Livewire AlpineJS , and Tailwind CSS. I am always eager to learn
					...
					>
						<div class="grid gap-3">
							...
							<div class="sm:grid sm:grid-cols-2 gap-5">
								<!--  -->
								<div class="sm:col-span-1 flex space-x-4 items-center">
									<svg
										class="h-12"
										viewBox="0 0 50 52"
										xmlns="http://www.w3.org/2000/svg"
									...
									<h1 class="text-white font-bold text-2xl">Laravel</h1>
								</div>
								<!--  -->
								<div class="sm:col-span-1 flex space-x-4 items-center">
									<svg
									...
									<h1 class="text-white font-bold text-2xl">Vue JS</h1>
								</div>
								<!--  -->
								<div class="sm:col-span-1 flex space-x-4 items-center">
									<img
										src="https://avatars.githubusercontent.com/u/51960834?s=100"
										class="h-12"
										alt=""
									/>
									<h1 class="text-white font-bold text-2xl">Livewire</h1>
								</div>
								<!--  -->
								<div class="sm:col-span-1 flex space-x-4 items-center">
									<img
										...
										alt=""
									/>
									<h1 class="text-white font-bold text-2xl">Inertai JS</h1>
								</div>
								<!--  -->
								<div class="sm:col-span-1 flex space-x-4 items-center">
									<svg
										viewBox="0 0 45.116 22.806"
										xmlns="http://www.w3.org/2000/svg"
										class="h-8"
									>
										<g opacity=".8">
											<path
												d="M33.71 0L11.207 22.693l.113.113h22.586l11.21-11.304z"
												fill="#d8dee9"
											/>
											<path
												d="M11.405 0l22.578 22.769-.039.037H11.209L0 11.502z"
												fill="#8ac0cf"
											/>
										</g>
									</svg>
									<h1 class="text-white font-bold text-2xl">Alpine JS</h1>
								</div>
								<div class="sm:col-span-1 flex space-x-4 items-center">
									<svg
										class="h-10"
									...
									<h1 class="text-white font-bold text-2xl">Tailwind CSS</h1>
								</div>
							</div>
						</div>
					</div>
					...
					>
						<div class="grid gap-3">
							...
							<h1 class="text-white font-semibold text-lg">
								Currently, I am looking for opportunities and accepting
								freelance projects. If you think I am a good asset, kindly send
								me a message.
							</h1>
